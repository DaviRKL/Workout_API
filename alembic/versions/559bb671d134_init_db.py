...
Revision ID: 559bb671d134
Revises: 
Create Date: 2024-06-28 14:48:05.799571
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.UUID(), nullable=False),
    sa.ForeignKeyConstraint(['atleta_id'], ['atletas.pk_id'], ),
    sa.ForeignKeyConstraint(['proprietario_id'], ['atletas.pk_id'], ),
    sa.PrimaryKeyConstraint('pk_id'),
